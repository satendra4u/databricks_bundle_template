"""Synchronous inference client for {{.project_name}}.

Calls the Model Serving endpoint and prints the response.
This example uses environment variables for auth:
- DATABRICKS_HOST
- DATABRICKS_TOKEN
"""
import os
...
def run() -> None:
    ...
    # Example simple input format; adjust to your serving handler
    inputs = [{"text": "Hello, agent!"}]
